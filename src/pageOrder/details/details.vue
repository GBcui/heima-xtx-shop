...
const getMemberOrderByIdData = async () => {
  ...
  if (
    [OrderState.DaiFuKuan, OrderState.DaiPingJia, OrderState.YiQuXiao].includes(
...
const onsubmit = () => {
  uni.showModal({
    ...
    success: async (success) => {
      if (success.confirm) {
        await getMemberOrderCancelByIdAPI(query.id, {
      ...
      <view class="overview" :style="{ paddingTop: safeAreaInsets!.top + 20 + 'px' }">
        ...
        <template v-else>
          ...
          <view class="button-group">
            ...
            <view v-if="isDEV && order.orderState === OrderState.DaiFaHuo" @tap="handleMockDeliver">
              模拟发货
            </view>
          </view>
        </template>
  ...
  <uni-popup ref="popup" type="bottom" background-color="#fff">
    <view class="popup-root">
      ...
      <view class="footer">
        ...
        <view class="button primary" @tap="onsubmit">确认</view>
      </view>
    </view>
  </uni-popup>
</template>
